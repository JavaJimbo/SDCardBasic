 ...
 *
 * 
 * 12-16-14 JBS: `A Modified SPI #2 pin definitions for LED Controller board Rev 1.0 
 * 8-5-18 JBS: Updated Defs.h to work for SNAD PIC or UBW32 boards.
********************************************************************/
#include "Defs.h"
...
#elif defined MDD_USE_SPI_2  // Pin definitions for LED Controll Board Rev 1.0 `A
